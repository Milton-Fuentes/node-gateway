...
import logging from './_configs/logging';
import config from './_configs/config';

import path from 'path';
import Routes from './_routes/index-routes';
const eurekaHelper = require('./_commons/eureka-helper');
...
eurekaHelper.registerWithEureka('node-gateway-service',  config.api.port);